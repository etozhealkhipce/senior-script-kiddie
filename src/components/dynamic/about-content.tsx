      ...
      <div className="flex flex-col space-y-4 font-light">
        ...
        <p>
          ...
          <span ref={addToTextRefs}>
            . In addition to coding, I have experience leading teams and setting up processes. I've
            been involved in designing architecture, making technical decisions, and helping my team
            grow.
          </span>
        </p>
        <p ref={addToTextRefs}>
